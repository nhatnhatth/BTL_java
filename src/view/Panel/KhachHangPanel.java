...
public class KhachHangPanel extends JPanel implements ActionListener, ItemListener {
    ...
    public ArrayList<model.KhachHang> listkh = khachhangBUS.getAll();
    Main m;
...
//        main.setBorder(new EmptyBorder(20, 20, 20, 20));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == mainFunction.btn.get("create")) {
            new AddKHDialog(owner, new AddKHDialog.Callback() {
                @Override
            ...
            if (index != -1) {
                new UpdateKHDialog(owner, listkh.get(index), new UpdateKHDialog.Callback() {
                    @Override
