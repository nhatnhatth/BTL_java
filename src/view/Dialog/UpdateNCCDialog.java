...
public class UpdateNCCDialog extends JDialog {
    ...
    public UpdateNCCDialog(JFrame parent, NhaCungCap kh, Callback callback) {
        super(parent, "Update khach hang", false);
        ...
        tenNCCField.setText(kh.getTenncc());
        ...
        themButton.addActionListener(e -> {
            String tenKH = tenNCCField.getText();
            String diachi = diachiField.getText();
            String sdt = sdtField.getText();
            callback.update(new NhaCungCap(kh.getMancc(), tenKH, diachi, sdt));
            dispose();
        });
