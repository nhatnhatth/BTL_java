...
public class UpdateNVDialog extends JDialog {
    ...
    public UpdateNVDialog(JFrame parent, NhanVien nv, Callback callback) {
        ...
        diachiField.setText(nv.getDiachi());
        ...
        themButton.addActionListener(e -> {
            String tenKH = tenNVField.getText();
            String diachi = diachiField.getText();
            String sdt = sdtField.getText();
            callback.update(new NhanVien(nv.getMaNV(), tenKH, diachi, sdt));
            dispose();
        });
