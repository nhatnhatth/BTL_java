...
public class PanelShadow extends JPanel {
    ...
    public PanelShadow(String linkIcon, String title, String content) {
        ...
        lblTitle.putClientProperty("FlatLaf.config.style", "font: 190% $h4.font");
        this.add(lblTitle);

        lblContent = new JLabel(content);
        lblContent.setForeground(Color.gray);
        lblContent.putClientProperty("FlatLaf.config.style", "font: 135% $medium.font");
        this.add(lblContent);
...
//        BufferedImage assets.img = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);
//        Graphics2D g = assets.img.createGraphics();
...
//        g2.drawImage(render.createShadow(assets.img), 0, 0, null);
//        g2.setPaint(shadowColor);
//
//        g2.drawImage(assets.img, x, y, null);
//    }
}
