...
public class itemTaskbar extends JPanel implements MouseListener {
    ...
    public itemTaskbar(String linkIcon, String content) {
        ...
        lblIcon.setIcon(new FlatSVGIcon(linkIcon));
        this.add(lblIcon);

        pnlContent = new JLabel(content);
        pnlContent.setPreferredSize(new Dimension(155, 30));
        pnlContent.putClientProperty("FlatLaf.config.style", "font: 145% $medium.font");
...
//        this.setPreferredSize(new Dimension(250, 45));
        ...
        pnlContent.putClientProperty("FlatLaf.config.style", "font: 200% $medium.font");
...
//        box[i].setBorder(new EmptyBorder(20, 20, 20, 20));
    ...
    public itemTaskbar(String linkImg, String tenSP, int soLuong) {
        ...
        img = new JLabel("");
        img.setIcon(InputImage.resizeImage(new ImageIcon("./src/assets.img_product/" + linkImg), 38));
        ...
        pnlContent.putClientProperty("FlatLaf.config.style", "font: 120% $semibold.font");
        ...
        pnlSoLuong.putClientProperty("FlatLaf.config.style", "font: 100% $medium.font");
    ...
    public itemTaskbar(String linkIcon, String content, String content2, int n) {
        ...
        pnlContent.putClientProperty("FlatLaf.config.style", "font: 300% $semibold.font");
        pnlContent.setForeground(FontColor);
        center.add(pnlContent);

        pnlContent1 = new JLabel(content2);
        pnlContent1.setPreferredSize(new Dimension(250, 30));
        pnlContent1.putClientProperty("FlatLaf.config.style", "font: 150% $medium.font");
