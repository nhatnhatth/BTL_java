...
(1, 'Điện thoại Samsung Galaxy S22', 15000000, 100, 'Điện thoại'),
(2, 'Laptop Dell XPS 13', 25000000, 50, 'Laptop'),
(3, 'Máy tính bảng iPad Air 5', 12000000, 70, 'Máy tính bảng'),
(4, 'Điện thoại IPhone 15', 29800000, 30, 'Điện thoại'),
(5, 'Rau Mùi', 5000, 10, 'Rau'),
(7, 'Hoa Lan', 200000, 1000, 'Hoa');
